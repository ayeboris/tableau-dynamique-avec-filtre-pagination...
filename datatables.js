 ...
 *   https://datatables.net/download/#dt/jq-3.6.0/dt-1.11.2/date-1.1.1/sc-2.0.5
 *
 * Included libraries:
 *   jQuery 3 3.6.0, DataTables 1.11.2, DateTime 1.1.1, Scroller 2.0.5
 */
	...
	pseudos: {
		...
		"text": function( elem ) {
			...
			return elem.nodeName.toLowerCase() === "input" &&
				...
				// Support: IE<8
				// New HTML5 attribute values (e.g., "Rechercher") appear with elem.type === "text"
...
(function( $, window, document, undefined ) {
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfo": "Montrer _START_ a _END_ de _TOTAL_ resultats",
			 ...
			 *    } );
			 */
			"sInfoEmpty": "Montrer 0 a 0 de 0 valeurs",
			 ...
			 *    } );
			 */
			"sLengthMenu": "Montrer _MENU_ resultats",
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"dt/jq-3.6.0/dt-1.11.2/date-1.1.1/sc-2.0.5",
	...
	$.extend( extPagination, {
		simple: function ( page, pages ) {
			return [ 'Precedent', 'Avancer' ];
		},
	
		full: function ( page, pages ) {
			return [  'Premiere', 'Precedent', 'Avancer', 'Dernier' ];
		},
		...
		simple_numbers: function ( page, pages ) {
			return [ 'Precedent', _numbers(page, pages), 'Avancer' ];
		},
	
		full_numbers: function ( page, pages ) {
			return [ 'Premiere', 'Precedent', _numbers(page, pages), 'Avancer', 'Dernier' ];
		},
